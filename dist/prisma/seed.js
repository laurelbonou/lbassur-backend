...
const insurers = [
    {
        ...
        categories: [client_1.InsuranceCategory.IARDT, client_1.InsuranceCategory.VIE],
    },
    {
        ...
        categories: [client_1.InsuranceCategory.IARDT],
    },
    {
        name: "SanlamAllianz",
        slug: "sanlam-allianz",
...
const insuranceTypes = [
    { label: "Assurance Automobile", category: client_1.InsuranceCategory.IARDT, subType: "Vehicules et Mobilite" },
    { label: "Assurance Moto", category: client_1.InsuranceCategory.IARDT, subType: "Vehicules et Mobilite" },
    { label: "Multirisque Habitation", category: client_1.InsuranceCategory.IARDT, subType: "Biens et Activite" },
    { label: "Multirisque Professionnelle", category: client_1.InsuranceCategory.IARDT, subType: "Biens et Activite" },
    { label: "Assurance Sante", category: client_1.InsuranceCategory.PERSONNES },
    { label: "Assurance Voyage", category: client_1.InsuranceCategory.PERSONNES },
    { label: "Epargne & Retraite", category: client_1.InsuranceCategory.VIE },
];
async function main() {
    const insurerBySlug = new Map();
    ...
    for (const offer of offers) {
        ...
        const created = await prisma.offer.upsert({
            ...
            update: {
                ...
                billingPeriod: client_1.BillingPeriod.ANNUAL,
    ...
    for (const rule of tariffRules) {
        ...
        await prisma.tariffRule.upsert({
            ...
            update: {
                ...
                category: type.category || client_1.InsuranceCategory.IARDT,
